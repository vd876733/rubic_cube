...
export const CanvasContainer = forwardRef<CanvasContainerHandle, CanvasContainerProps>(
  ({ cubeState, onMirrorStickerChange }, ref) => {
    ...
    /**
     * handleMirrorStickerChange - Handle sticker color changes with validation
    ...
    return (
      <div className="h-full flex flex-col overflow-hidden bg-slate-950/80 backdrop-blur-xl border border-white/10 rounded-lg">
        ...
        <div className="flex-shrink-0 px-4 pt-4">
          <Palette ref={paletteRef} selectedColor={selectedColor} onColorSelect={setSelectedColor} />
        </div>
          ...
          <div className="flex-1 rounded-lg overflow-hidden bg-slate-900/30 backdrop-blur-sm border border-cyan-500/20 shadow-[0_0_20px_rgba(34,211,238,0.15)]">
            <div className="w-full h-full">
              <CubeScene
                ...
                cubeState={cubeState}
                isMirror={true}
                onStickerChange={handleMirrorStickerChange}
